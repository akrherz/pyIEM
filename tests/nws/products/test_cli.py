...
def test_clippg4():
    ...
    prod = cliparser(get_test_file("CLI/CLIPPG4.txt"))
    assert prod.data[0]["data"]["temperature_maximum_record_years"][0] == 1999
    assert abs(prod.data[0]["data"]["precip_today"] - 0.02) < 0.01
